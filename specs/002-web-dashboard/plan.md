...
1. **Current readings** (US1, #33): Displays live solar, battery, home load, and grid metrics for 2 EP Cube devices in a side-by-side grid, auto-polling every 30 seconds (FR-012), with stale/offline indicators when data exceeds 3 minutes old. Includes animated energy flow diagram (FR-017) with toggle to gauge dial view.
