"""Mock EP Cube data generator — writes synthetic telemetry to PostgreSQL.
...
# Track cumulative counters across write cycles
_cumulative = {}
    ...
    while True:
        ...
        try:
            ...
            for i, dev in enumerate(DEVICES):
                # Generate the same values used by the real exporter
                now_jst = _dt.now(JST)
...
if __name__ == "__main__":
    ...
    print(f"Mock exporter: serving on :{port}/health", flush=True)
