...
import { PollingIntervalsSection } from '../../../src/components/settings/PollingIntervalsSection';

describe('PollingIntervalsSection', () => {
  it('renders polling interval inputs with current values from API', async () => {
    ...
    // Act
    render(<PollingIntervalsSection />);
  ...
  it('does not update state after unmount during load', async () => {
    ...
    // Act
    const { unmount } = render(<PollingIntervalsSection />);
    unmount();
